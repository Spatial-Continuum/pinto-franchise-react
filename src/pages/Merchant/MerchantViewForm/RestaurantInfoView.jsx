    ...
    <div className="p-6">
        ...
        <div className="">
          ...
          <div className="flex flex-col w-1/2 mt-4 mb-4">
            ...
            <input
              ...
              } rounded-md focus:outline-none focus:ring-2 focus:ring-blue-50`}
            />
          </div>
        </div>
      </div>
        ...
        <div className="w-5/6 bg-gray-100 p-4 border border-gray-300 rounded-lg mt-2">
          <div className="flex flex-col w-3/6">
            ...
            <input
              ...
              className={`px-3 py-2 border ${
                validFields.gst_number ? "border-gray-300" : "border-red-500"
              } rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}
            />
          </div>
        </div>
      ...
      <div className="w-2/3 bg-gray-100 p-4 border border-gray-300 rounded-lg mt-2">
          ...
          <div className="flex flex-row w-full">
            <div className="flex flex-col w-3/4">
              ...
              <input
                ...
                disabled={!isEditable}
                className={`px-3 py-2 border ${
                  validFields.owner_name ? "border-gray-300" : "border-red-500"
                } rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}
              />
            </div>
        ...
        {ownerPopup && ownerDetails && (
          <div className="relative top-full left-0 w-2/6 p-4 bg-[#FFFFFF] border-1px border-[#d6cbcb] justify-center items-center z-50 mt-5 rounded-lg">
