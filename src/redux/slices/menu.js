...
export const fetchCategoryApi = createAsyncThunk('api/fetchFirstApi', async ( _,{ rejectWithValue }) => { 
  ...
  export const fetchQuickFilterApi = createAsyncThunk('api/fetchQuickFilter', async ( _,{ rejectWithValue }) => { 
    ...
    export const fetchTopBrandApi = createAsyncThunk('api/fetchTopBrand', async ( _,{ rejectWithValue }) => { 

      try {
        const response = await axios.get(`${API_URL}/restaurant/merchant/toprestaurants`); // Replace with your first API URL
        return response.data;
      } catch (error) {
        return rejectWithValue(error.response?.data || error.message);
      }
    });
    export const fetchAuthenticateApi = createAsyncThunk('api/fetchAuthenticate', async ( _,{ rejectWithValue }) => { 

      try {
        const response = await axios.get(`${API_URL}/restaurant/merchant/authentic-restaurants`); // Replace with your first API URL
        return response.data;
      } catch (error) {
        return rejectWithValue(error.response?.data || error.message);
      }
    }); 
    export const fetchQuickRestaurantApi = createAsyncThunk('api/fetchQuickRestaurant', async ( _,{ rejectWithValue }) => { 
  
      try {
        const response = await axios.get(`${API_URL}/restaurant/menu/quickfilterrestaurant`); // Replace with your first API URL
        return response.data;
      } catch (error) {
        return rejectWithValue(error.response?.data || error.message);
      }
  ...
  export const selectApiError = (state) => state.menu.error;
   ...
   export const selectQuickRestaurant = (state)=>state.menu.fetchQuickRestaturant
