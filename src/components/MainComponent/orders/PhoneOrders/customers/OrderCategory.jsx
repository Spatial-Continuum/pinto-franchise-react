        ...
        <div className="w-full">
            ...
            <div className="flex  items-center mt-6 px-6">
                <div className="flex w-8/12 justify-between items-center ">
                    <button className="text-[#FF6B00] font-semibold text-lg">Menu</button>
            ...
            <div className="flex gap-4 mt-4 px-6">
                {categories.map((category, index) => (
                    <span
                        key={index}
                        className="bg-[#FAFAFA] border-[#030714] border-[1px] px-4 py-2 rounded-lg text-gray-700 hover:bg-orange-500 hover:text-white cursor-pointer"
                    >
                        {category}
                    </span>
                ))}
