...
const CustomerDetail = () => {
  ...
  const getValidationSchema = (AddNewAddress) =>
    Yup.object().shape({
      username: AddNewAddress
        ? Yup.string()
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (!AddNewAddress) {
        ...
        console.log("AddNewAddress:", values);
        ...
        <div className="w-full p-4">
          ...
          {!loading && restaurantDetails && (
            <>
              ...
              <div className="border border-[#D4D4D4] rounded-lg p-4 shadow-sm">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        ...
                        {restaurantDetails.street_address_1}
                      </p>
                    </div>
                  </div>
                  {/* Right Section */}
                  <div className="text-right">
                    ...
                    <p className="text-lg  text-gray-800 font-medium">
                      {restaurantDetails.primary_phone} &nbsp;{" "}
                      {restaurantDetails.secondary_phone &&
                        `${-restaurantDetails.secondary_phone}`}
                    </p>
              ...
              <div className="mt-6">
                <h2 className="font-bold font-Roboto text-xl mb-4">
                  {!AddNewAddress ? "Customer detail" : ""}
                </h2>
              </div>

              {AddNewCustomerModal || AddNewAddress ? (
                <div
                  className={`${AddNewAddress} ? bg-white p-5 shadow-lg flex mt-6 gap-4 : flex mt-6 gap-4`}
                >
                  {/* Left Column */}
                  ...
                  <div className="w-2/3">
                    <div className="flex text-center w-full justify-center">
                      {messages.error &&
                        Object.entries(messages.error).map(
                          ([field, messages]) =>
                    ...
                    {!AddNewAddress ? (
                      <div
                        className={`${AddNewAddress} ? border-none :border rounded-lg p-4 space-y-4`}
                      >
                        {/* Input Fields */}
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="w-1/2">
                            ...
                            <input
                              ...
                              name="sublocality"
                            />
                            {formik.touched.sublocality &&
                              formik.errors.sublocality && (
                                <div className="text-red-500 text-sm">
                                  {formik.errors.sublocality}
                                </div>
                              )}
                        ...
                        <div className="flex gap-4">
                          <div>
                            ...
                            <div className="radio-group flex gap-4 mt-3">
                              {["Hand it to me", "Leave it at the door"].map(
                                (option) => (
                                  <label
                                    key={option}
                                    style={{
                                  ...
                                  >
                                    <input
                                      ...
                                      value={option}
                                      checked={
                                        formik.values.delivery_option === option
                                      }
                                      onChange={(e) => {
                        ...
                        <div>
                          ...
                          />
                          {formik.touched.delivery_instructions &&
                            formik.errors.delivery_instructions && (
                              <div className="text-red-500 text-sm">
                                {formik.errors.delivery_instructions}
                              </div>
                            )}
                        ...
                        <div className="flex justify-center gap-4 mt-4">
                          <button
                            type="button"
                            className="px-6 py-2 border border-gray-300 rounded-lg bg-gray-100 hover:bg-gray-200"
                            onClick={() => {
                              formik.resetForm();
                  ...
                  <div className="w-1/3">
                    ...
                    <h4 className="font-medium text-md mb-4">
                      {AddNewAddress
                ...
                <div className="border border-[#D4D4D4] rounded-lg p-4 shadow-sm w-10/12">
                  <div>
                    <label className="block font-regular text-black">
                      Mobile Number
                    </label>
                      ...
                      {Searchloadings ? (
                        ...
                        <div className="flex justify-start flex-col mt-4 h-full">
                          <div className="flex flex-col gap-2 bg-white p-4 rounded-lg border border-[#D4D4D4] w-96 shadow-lg">
                            <span>
                              <h2 className="font-bold text-lg text-[#00840D]">
                                Customer Found
                              </h2>
                            </span>
                            ...
                            <span className="text-sm text-black flex">
                              {" "}
                              <p className="w-32">Customer Name</p>{" "}
                          ...
                          <div className="flex flex-wrap gap-2 mt-4">
                            {Location?.addresses?.map((item) => (
                              <div
                                key={item.address_id}
                                className="flex flex-col gap-2 bg-white p-4 rounded-lg border border-[#D4D4D4] w-96 shadow-lg"
                              >
                                <div className="radio-item">
                                  ...
                                  />
                                  <label htmlFor={`radio-${item.address_id}`}>
                                ...
                                <div>
                                  <p>
                                    {item?.address_line_1}, {item?.street},{" "}
                                    {item?.sublocality}, {item?.city},{" "}
                                    {item?.state}
                                  </p>
                                </div>
                              </div>
                        ...
                        <div className="flex justify-start flex-col mt-4">
                          <div className="flex flex-col gap-2 bg-white p-4 rounded-lg border border-[#D4D4D4] w-96 shadow-lg">
                            <h2 className="font-bold text-lg text-[#FF0000]">
                              No Customer Found
                            </h2>
                            <span className="text-sm text-black flex">
                              <p className="w-32">Phone Number</p>{" "}
                            ...
                            <button
                              className="bg-[#008B0E] text-white rounded-lg px-6 py-2 mt-4 w-1/2"
                              onClick={() => {
                  ...
                  {Location?.addresses?.length > 0 && (
                    <button
                      onClick={() => {
                        navigate(
                          `/orders/restaurant_customer/${id}/${Location.user_id}`
                        );
                      }}
                      type="button"
