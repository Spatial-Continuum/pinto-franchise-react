...
import { CreateNewAddress, CreateNewCustomer, Searchloading, SearchMobileNumber, UpdateCustomerPrimaryAddress } from '../../../../../redux/slices/order';
import {
    GoogleMap,
    Marker,
    useJsApiLoader,
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">{restaurantDetails.street},{restaurantDetails.street_address_1}</p>
                                        </div>
                                    </div>
                                    {/* Right Section */}
                                    <div className="text-right">
                                        {/* <p className="font-bold text-sm">{restaurantDetails.primary_phone}-{restaurantDetails.secondary_phone}</p> */}
                                        <p className="text-lg  text-gray-800 font-medium">{restaurantDetails.primary_phone} &nbsp; {restaurantDetails.secondary_phone && `${- restaurantDetails.secondary_phone}`}</p>
                                                ...
                                                !AddNewAddress ? (
                                                    <div className={`${AddNewAddress} ? border-none :border rounded-lg p-4 space-y-4`}>
                                                        ...
                                                        <div className="flex justify-center gap-4 mt-4">
                                                            <button type='button' className="px-6 py-2 border border-gray-300 rounded-lg bg-gray-100 hover:bg-gray-200" onClick={() => { formik.resetForm(); setAddNewAddress(false); setSearch(''); setLocation([]); }}>
                                                                Cancel
                                                            </button>
                                                            <button
