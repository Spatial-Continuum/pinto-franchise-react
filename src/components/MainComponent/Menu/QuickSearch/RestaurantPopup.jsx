...
import { searchRestaurantByName, selectSearchResults, resetRestaurants,   selectApiLoading,selectApiError } from '../../../../redux/slices/restaurant';
                        ...
                        {restaurants.map((restaurant) => (
                            ...
                            >
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-sm text-gray-600">{restaurant.street_address_1}{restaurant.street_address_2}</p>
                            ...
                            {selectedRestaurants.map((restaurant) => (
                                ...
                                >
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <p className="text-sm text-[#FFFFFF] w-2/12 flex justify-items-start pl-2 gap-2 rounded-md bg-green-600 border-[0.1px]"> <img src={star} alt="" /> {restaurant.average_rating}</p>
                                        <p className="text-sm text-gray-600">{restaurant.number_of_ratings} ratings</p>
                                        </div>
                                        <p className="text-sm text-gray-600">{restaurant.primary_phone}     {restaurant.secondary_phone}</p>
                                        <p className="text-sm text-gray-600">Timings: {getCurrentDayHours(restaurant.opening_hours)}</p>
